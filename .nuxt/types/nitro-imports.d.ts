declare global {
  ...
  const setResponse: typeof import('../../server/utils/set-response')['default']
...
declare global {
  // @ts-ignore
  export type { ISetResponse } from '../../server/utils/set-response'
  import('../../server/utils/set-response')
}
...
export { default as setResponse } from '../../server/utils/set-response';