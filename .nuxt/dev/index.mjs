...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file://E:/Barcode%20Issue/user-reg-form/node_modules/h3/dist/index.mjs';
import mongoose, { Error as Error$1 } from 'file://E:/Barcode%20Issue/user-reg-form/node_modules/mongoose/index.js';
import messagingApi from 'file://E:/Barcode%20Issue/user-reg-form/node_modules/@cmdotcom/text-sdk/dist/lib/index.js';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://E:/Barcode%20Issue/user-reg-form/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://E:/Barcode%20Issue/user-reg-form/node_modules/devalue/index.js';
import destr from 'file://E:/Barcode%20Issue/user-reg-form/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash } from 'file://E:/Barcode%20Issue/user-reg-form/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://E:/Barcode%20Issue/user-reg-form/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file://E:/Barcode%20Issue/user-reg-form/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file://E:/Barcode%20Issue/user-reg-form/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://E:/Barcode%20Issue/user-reg-form/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://E:/Barcode%20Issue/user-reg-form/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://E:/Barcode%20Issue/user-reg-form/node_modules/hookable/dist/index.mjs';
import { klona } from 'file://E:/Barcode%20Issue/user-reg-form/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file://E:/Barcode%20Issue/user-reg-form/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file://E:/Barcode%20Issue/user-reg-form/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file://E:/Barcode%20Issue/user-reg-form/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://E:/Barcode%20Issue/user-reg-form/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://E:/Barcode%20Issue/user-reg-form/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://E:/Barcode%20Issue/user-reg-form/node_modules/consola/dist/index.mjs';
import devalue from 'file://E:/Barcode%20Issue/user-reg-form/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { getContext } from 'file://E:/Barcode%20Issue/user-reg-form/node_modules/unctx/dist/index.mjs';
import { version, unref } from 'file://E:/Barcode%20Issue/user-reg-form/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://E:/Barcode%20Issue/user-reg-form/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://E:/Barcode%20Issue/user-reg-form/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"E:/Barcode Issue/user-reg-form/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"E:\\Barcode Issue\\user-reg-form","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"E:\\Barcode Issue\\user-reg-form\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"E:\\Barcode Issue\\user-reg-form\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"E:\\Barcode Issue\\user-reg-form\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"E:\\Barcode Issue\\user-reg-form\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _S8NO8EXZKV = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "E:/Barcode Issue/user-reg-form";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _cANVpqxKdh = (nitroApp) => {
...
const _lazy_ZmEEgQ = () => Promise.resolve().then(function () { return test$1; });
const _lazy_1aeETT = () => Promise.resolve().then(function () { return index$1; });
const _lazy_h2QaeD = () => Promise.resolve().then(function () { return post$1; });
const _lazy_TQaXVZ = () => Promise.resolve().then(function () { return update$1; });
const _lazy_72pjRr = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/test', handler: _lazy_ZmEEgQ, lazy: true, middleware: false, method: undefined },
  { route: '/api/user', handler: _lazy_1aeETT, lazy: true, middleware: false, method: undefined },
  { route: '/api/user/post', handler: _lazy_h2QaeD, lazy: true, middleware: false, method: undefined },
  { route: '/api/user/update', handler: _lazy_TQaXVZ, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_72pjRr, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_72pjRr, lazy: true, middleware: false, method: undefined }
];
...
const User = mongoose.model("User", schema$1);
...
const setResponse = (event, responseData) => {
  ...
  } else if (responseData.cause === void 0) {
    return {
      statusCode: event.node.res.statusCode,
      statusMessage: event.node.res.statusMessage,
      data: responseData.data
    };
  } else if (responseData.cause === void 0 && responseData.data === void 0) {
    return {
      statusCode: event.node.res.statusCode,
      statusMessage: event.node.res.statusMessage
    };
...
async function sendSMS(code, phone, event) {
...
const getErrors$1 = (err, event) => {
  if (err) {
    if (err == null ? void 0 : err.errors) {
      ...
      if (err instanceof Error$1.ValidationError) {
        return setResponse(event, {
          statusCode: 400,
...
const update = defineEventHandler(async (event) => {
  try {
    ...
    const item = await OTP.findOne({ userId: body.userId, code: body.code });
    if (item != null || item != void 0) {
      await User.findByIdAndUpdate({ _id: body.userId }, { phoneVerified: true });
...
const getClientManifest = () => import('file://E:/Barcode%20Issue/user-reg-form/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://E:/Barcode%20Issue/user-reg-form/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
